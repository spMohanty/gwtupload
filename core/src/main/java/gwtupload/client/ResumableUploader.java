 ...
 *
 */
public class ResumableUploader extends Uploader {
   ...
   */
  @UiConstructor
  public ResumableUploader(FileInputType type) {
    this(type, null);
  }
   ...
   */
  public ResumableUploader(FileInputType type, IUploadStatus status) {
   ...
   */
  public ResumableUploader(FileInputType type, IUploadStatus status, Widget submitButton) {
   ...
   */
  public ResumableUploader(FileInputType type, IUploadStatus status, Widget submitButton, FormPanel form) {
    super(type, form);
   ...
   *        Customized status widget to use
   */
  public ResumableUploader(IUploadStatus status) {
   ...
   *        Customized button which submits the form
   */
  public ResumableUploader(IUploadStatus status, Widget submitButton) {
