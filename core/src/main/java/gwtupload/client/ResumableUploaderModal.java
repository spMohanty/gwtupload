 ...
 *
 */
public class ResumableUploaderModal extends ResumableUploader {
   ...
   * 
   */
  public ResumableUploaderModal() {
    this(FileInputType.BROWSER_INPUT);
  }

  @UiConstructor
  public ResumableUploaderModal(FileInputType type) {
   ...
   */
  public ResumableUploaderModal(FileInputType type, IUploadStatus status) {
   ...
   */
  public ResumableUploaderModal(FileInputType type, IUploadStatus status, Widget submitButton) {
   ...
   */
  public ResumableUploaderModal(FileInputType type, IUploadStatus status, Widget submitButton, FormPanel form) {
   ...
   *        Customized status widget to use
   */
  public ResumableUploaderModal(IUploadStatus status) {
   ...
   *        Customized button which submits the form
   */
  public ResumableUploaderModal(IUploadStatus status, Widget submitButton) {
